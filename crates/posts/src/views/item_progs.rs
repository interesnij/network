...
pub async fn community_unfixed (
    req: HttpRequest,
    state: web::Data<AppState>,
    data: Json<ItemParams>
) -> Result<Json<i16>, Error> {
...
pub async fn send_reaction_post (
    req: HttpRequest,
    state: web::Data<AppState>,
