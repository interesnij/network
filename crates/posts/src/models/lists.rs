    ...
    pub fn is_user_see_el(&self, user_id: i32) -> bool {
        ...
        if self.community_id.is_some() {
            ...
            return match private_field {
                ...
                3 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (!self.get_see_el_exclude_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                4 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (self.get_see_el_include_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                5 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (!self.get_see_el_exclude_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                6 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (self.get_see_el_include_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
    ...
    pub fn is_user_see_comment(&self, user_id: i32) -> bool {
        ...
        if self.community_id.is_some() {
            ...
            return match private_field {
                1 => true,
                2 => creator.get_friends_ids().iter().any(|&i| i==user_id) || self.get_friends_ids().iter().any(|&i| i==user_id),
                3 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (!self.get_see_comment_exclude_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                4 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (self.get_see_comment_include_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                5 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (!self.get_see_comment_exclude_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                6 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (self.get_see_comment_include_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                7 => creator.get_friends_ids().iter().any(|&i| i==user_id),
    ...
    pub fn is_user_create_el(&self, user_id: i32) -> bool {
        ...
        if self.community_id.is_some() {
            ...
            return match private_field {
                1 => true,
                2 => creator.get_friends_ids().iter().any(|&i| i==user_id) || self.get_friends_ids().iter().any(|&i| i==user_id),
                3 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (!self.get_create_el_exclude_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                4 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (self.get_create_el_include_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                5 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (!self.get_create_el_exclude_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                6 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (self.get_create_el_include_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                7 => creator.get_friends_ids().iter().any(|&i| i==user_id),
    ...
    pub fn is_user_create_comment(&self, user_id: i32) -> bool {
        ...
        if self.community_id.is_some() {
            ...
            return match private_field {
                1 => true,
                2 => creator.get_friends_ids().iter().any(|&i| i==user_id) || self.get_friends_ids().iter().any(|&i| i==user_id),
                3 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (!self.get_create_comment_exclude_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                4 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (self.get_create_comment_include_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                5 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (!self.get_create_comment_exclude_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                6 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (self.get_create_comment_include_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                7 => creator.get_friends_ids().iter().any(|&i| i==user_id),
    ...
    pub fn is_user_copy_el(&self, user_id: i32) -> bool {
        ...
        if self.community_id.is_some() {
            ...
            return match private_field {
                1 => true,
                2 => creator.get_friends_ids().iter().any(|&i| i==user_id) || self.get_friends_ids().iter().any(|&i| i==user_id),
                3 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (!self.get_copy_el_exclude_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                4 => creator.get_friends_ids().iter().any(|&i| i==user_id) || (self.get_copy_el_include_follows_ids().iter().any(|&i| i==user_id) && creator.get_follows_ids().iter().any(|&i| i==user_id)),
                5 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (!self.get_copy_el_exclude_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                6 => creator.get_follows_ids().iter().any(|&i| i==user_id) || (self.get_copy_el_include_friends_ids().iter().any(|&i| i==user_id) && creator.get_friends_ids().iter().any(|&i| i==user_id)),
                7 => creator.get_friends_ids().iter().any(|&i| i==user_id),
