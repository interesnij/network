...
102 список может видеть комменты
103 список может создавать фото
104 список может создавать комменты
105 список может копировать / репостить
111 список не может видеть фото
112 список не может видеть комменты
113 список не может создавать фото
114 список не может создавать комменты
115 список не может копировать / репостить
