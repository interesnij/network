...
impl Community {
    ...
    pub fn get_main_photo_list(&self) -> PhotoList {
        ...
        if _photo_list.is_ok() {
            ...
            use crate::models::{NewPhotoList, NewCommunityPhotoListPosition};
        ...
        if is_ie_mode {
            ...
            match value { 
                ...
                106 => diesel::delete (
                    community_visible_perms
                        .filter(schema::community_visible_perms::community_id.eq(self.community_id))
                        .filter(schema::community_visible_perms::types.eq(116))
                    )
                    .execute(&_connection)
                    .expect("E"),
                101 => diesel::delete (
                ...
                116 => diesel::delete (
                    community_visible_perms
                        .filter(schema::community_visible_perms::community_id.eq(self.community_id))
                        .filter(schema::community_visible_perms::types.eq(106))
                    )
                    .execute(&_connection)
                    .expect("E"),
                111 => diesel::delete (
    ...
    pub fn get_photo_lists (
        ...
        let _connection = establish_connection();
        return photo_lists
            .filter(schema::photo_lists::community_id.eq(self.community_id))
    ...
    pub fn search_comments (
        ...
        while _count < _limit {
            ...
            let items = photo_comments
                .filter(schema::photo_comments::community_id.eq(self.id))
    ...
    pub fn create_community (
        ...
        let _community = diesel::insert_into(schema::communitys::table)
            ...
            .expect("Error.");
        _community.create_main_photo_list();
        return 1;
    }
    ...
    pub fn plus_photos(&self, count: i32) -> bool {
        let _connection = establish_connection();
        diesel::update(self)
            .set(schema::communitys::photos.eq(self.photos + count))
            .execute(&_connection)
            .expect("Error.");
        return true;
    }
...
106 список может создавать списки
...
116 список не может создавать списки
