...
pub fn get_photo_list(pk: i32) -> Result<PhotoList, Error> {
...
pub fn get_photo(pk: i32) -> Result<Photo, Error> {
...
pub fn get_photo_comment(pk: i32) -> Result<PhotoComment, Error> {
