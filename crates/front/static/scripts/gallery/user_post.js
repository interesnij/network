...
on('#ajax', 'click', '.photo_description', function() {
  ...
  form_data.append("id", this.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.getAttribute("data-pk"));

  link_ = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject( 'Microsoft.XMLHTTP' );
  link_.open('POST', "/photos/edit_photo_description", true );
