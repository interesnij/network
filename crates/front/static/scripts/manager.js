...
on('#ajax', 'click', '#create_communities_category_btn', function() {
  send_form_and_close_window("/admin/created/create_communities_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_goods_category_btn', function() {
  send_form_and_close_window("/admin/created/create_goods_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '.create_sound_genre_btn', function() {
  send_form_and_close_window("/admin/created/create_sound_genre", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_artist_btn', function() {
  send_form_and_close_window("/admin/created/create_artist", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_music_album_btn', function() {
  send_form_and_close_window("/admin/created/create_music_album", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_post_category_btn', function() {
  send_form_and_close_window("/admin/created/create_post_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_video_category_btn', function() {
  send_form_and_close_window("/admin/created/create_video_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_stickers_category_btn', function() {
  send_form_and_close_window("/admin/created/create_stickers_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_sticker_btn', function() {
  send_form_and_close_window("/admin/created/create_sticker", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_smiles_category_btn', function() {
  send_form_and_close_window("/admin/created/create_smiles_category", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_smile_btn', function() {
  send_form_and_close_window("/admin/created/create_smile", 0, this.parentElement.parentElement.parentElement);
});
...
on('#ajax', 'click', '#create_reaction_btn', function() {
  send_form_and_close_window("/admin/created/create_reaction", 0, this.parentElement.parentElement.parentElement);
});
